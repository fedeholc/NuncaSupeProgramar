...
Para configurar la rama y el repositorio remoto por defecto: `git branch --set-upstream-to=origin/main`
...
![Diagrama que muestra la diferencia entre git merge y git rebase](git-merge-rebase.webp)
